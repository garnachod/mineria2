...
package es.uam.eps.bmi.search.indexing.stemmer.ext;

import es.uam.eps.bmi.search.indexing.stemmer.Among;
...
public class englishStemmer extends es.uam.eps.bmi.search.indexing.stemmer.SnowballStemmer {
